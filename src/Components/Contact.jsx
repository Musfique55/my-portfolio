...
const Contact = () => {
    return (
        <div id="contact" className=" relative px-5  mb-10 lg:px-12">
            <div className="h-full w-1/3 bg-[#c471ed] absolute blur-3xl rounded-full left-0 m-auto  lg:left-10 right-0 top-0 bottom-0 opacity-15 lg:m-0 "></div>
            <div className=" h-full w-1/3 hidden bg-[#f64f59] absolute blur-3xl rounded-full left-50 right-0 top-0 bottom-0 opacity-15 lg:flex"></div>
           ...
           <div className="flex flex-col gap-10 items-center lg:flex-row">
                ...
                <form className="flex-1 grid grid-cols-2 gap-3 border p-5 rounded-2xl">
                    <input type="text" placeholder="Name" className="px-3 col-span-2 lg:col-span-1 py-2 placeholder:bg-[#242424] focus:bg-[#242424] bg-[#242424] outline-none border-none text-white rounded-2xl mb-8"/>
                    <input type="email" placeholder="Email" className="px-3 col-span-2 lg:col-span-1 py-2 placeholder:bg-[#242424] focus:bg-[#242424] bg-[#242424] outline-none border-none text-white rounded-2xl mb-8"/>
